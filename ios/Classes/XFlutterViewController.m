...
- (void)tryPopRoute{
    ...
    if(!ary.count){
        [[HybridStackManager sharedInstance].methodChannel invokeMethod:@"popToRoot"
                                                              arguments:nil];
    }
    ...
    if(idx == NSNotFound){
        [[HybridStackManager sharedInstance].methodChannel invokeMethod:@"popRouteNamed"
                                                              arguments:self.curFlutterRouteName];
    }
}
